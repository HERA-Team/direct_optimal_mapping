...
class DataConditioning:
    ...
    def __init__(self, uv, ifreq, ipol):
        ...
        '''
        uv_1d = uv.select(
            freq_chans=ifreq, polarizations=ipol,
    ...
    def redundant_avg(self, uv, tol=1.0):
        ...
        uv_red_avg = uv.compress_by_redundancy(
            tol=tol,
            method='average',
            inplace=False,
    ...
    def redundant_grouping(self, tol=1.0):
        ...
        bl_groups, uvw_groups, _ = self.uv.get_redundancies(
            tol=self.tol,
            use_antpos=False,
        ...
        # redundant baseline averaging
        uv_red_avg = self.uv.compress_by_redundancy(
            tol=self.tol,
            method='average',
            inplace=False,
            keep_all_metadata=False,
