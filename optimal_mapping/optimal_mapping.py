...
class OptMapping:
    ...
    def set_pyuvbeam(self, beam_model):
        ...
        if beam_model == 'vivaldi':
            ...
            beamfits_file = '/nfs/esc/hera/zhileixu/data/git_beam/HERA-Beams/NicolasFagnoniBeams/NF_HERA_Dipole_efield_beam_high-precision.fits'
            #beamfits_file = '/nfs/esc/hera/zhileixu/data/git_beam/cst_beam_files/fagnoni_high_precision_dipole/H19/'+\
    ...
    def beam_interp_onecore(self, time, pix):
        ...
        pyuvbeam_interp_e, vectors = self.pyuvbeam.interp(az_array=np.mod(np.pi/2. - az_t, 2*np.pi), 
                                                          za_array=np.pi/2. - alt_t, 
